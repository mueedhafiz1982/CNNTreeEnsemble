# -*- coding: utf-8 -*-
"""Struct_No.2: 6Rs_BP_ImgNt.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ZWpIXu9dnv6mx9PiFhVbngB_ixHqS-GI
"""
...
train_generator1 = train_datagen.flow_from_directory(
        ...
        classes = ['bikes_ships_tractors','cats_dogs_wagons'],
...
model1.save ( '/content/drive/My Drive/db/6C/Bipartite_Adam_pln_pp2/model1/' )
model21.save( '/content/drive/My Drive/db/6C/Bipartite_Adam_pln_pp2/model21/')
model22.save( '/content/drive/My Drive/db/6C/Bipartite_Adam_pln_pp2/model22/')

"""
import tensorflow as tf
model1 =tf.keras.models.load_model('/content/drive/My Drive/db/6C/Bipartite_Adam_pln_pp2/model1/' )
model21=tf.keras.models.load_model('/content/drive/My Drive/db/6C/Bipartite_Adam_pln_pp2/model21/')
model22=tf.keras.models.load_model('/content/drive/My Drive/db/6C/Bipartite_Adam_pln_pp2/model22/')
"""
...
for f1 in files:
  ...
  if((classesb1[0] < .5) and (classesb21[0][0] > .5)):    ct_bike=ct_bike+1
...
for f1 in files:
  ...
  if((classess1[0] < .5) and (classess21[0][1] > .5)):    ct_ship=ct_ship+1
...
for f1 in files:
  ...
  if((classest1[0] < .5) and (classest21[0][2] > .5)):    ct_tractor=ct_tractor+1
...
for f1 in files:
  ...
  if((classesw1[0] > .5) and (classesw22[0][0] > .5)):    ct_cat=ct_cat+1
...
for f1 in files:
  ...
  if((classesw1[0] > .5) and (classesw22[0][2] > .5)):    ct_wagon=ct_wagon+1
...
#baseline: Total = 1022, Acc = .8963



#old
#home(Tailored):  917, .8973
#home(224):       910, Breakup =  157 165 174 167 135 112
#home(299):       916, Breakup =  157 162 169 176 142 110
#home(Tailored)   926, Breakup =  Best of above             (.9061)
